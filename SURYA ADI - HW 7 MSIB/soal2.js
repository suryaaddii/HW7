...
// Data content untuk dilakukan proses write data
const dataSample = `
...
// File path untuk proses write ataupun read data
const filePath = "log.txt";


// Melakukan write data pada file path yang dituju
fs.writeFile(filePath, dataSample, 'utf-8', (err) => {

    // jika terjadi error atau kesalahan maka akan muncul pesan error
    if (err) {
        console.error('Terjadi kesalahan pada saat write data');
        return;
    }

    console.log('Write data berhasil dilakukan');
});


// Melakukan read data pada file path yang dituju
fs.readFile(filePath, 'utf-8', (err, data) => {

    // jika terjadi error atau kesalahan maka akan muncul pesan error
    if (err) {
        console.error('Terjadi kesalahan pada saat read data');
        return;
    }

    console.log('Read data berhasil, Data Sample : ', data);
});